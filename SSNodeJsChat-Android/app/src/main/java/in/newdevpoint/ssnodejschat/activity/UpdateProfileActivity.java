...
//        mWaitingDialog = new Waiting(LoginActivity.this);
        ...
        loginBinding.editProfileEmail.setText(UserDetails.myDetail.getEmail());
        ...
        loginBinding.editProfileEmail.setText(UserDetails.myDetail.getEmail());
        loginBinding.editProfileName.setText(UserDetails.myDetail.getName());
        Glide.with(this)
                .setDefaultRequestOptions(AppApplication.USER_PROFILE_DEFAULT_GLIDE_CONFIG)
                .load(Utils.getImageString(UserDetails.myDetail.getProfile_image()))
